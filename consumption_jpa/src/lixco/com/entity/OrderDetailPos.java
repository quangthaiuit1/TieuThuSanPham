...
@Entity
@Table(name="orderdetailpos")
public class OrderDetailPos implements Serializable,Cloneable{
	...
	@ManyToOne(fetch=FetchType.LAZY)
	private OrderLixPos order_lix_pos;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrderDetailPos other = (OrderDetailPos) obj;
		if (id != other.id)
			return false;
		return true;
	}
	@Override
	public OrderDetailPos clone() throws CloneNotSupportedException {
		return (OrderDetailPos)super.clone();
	}
