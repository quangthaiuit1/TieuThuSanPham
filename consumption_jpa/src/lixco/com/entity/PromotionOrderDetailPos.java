...
@Entity
@Table(name="promotionorderdetailpos")
public class PromotionOrderDetailPos implements Serializable,Cloneable{
	...
	@ManyToOne(fetch=FetchType.LAZY)
	private OrderDetailPos order_detail_pos;
	...
	@Override
	public PromotionOrderDetailPos clone() throws CloneNotSupportedException {
		return (PromotionOrderDetailPos)super.clone();
	}
}
