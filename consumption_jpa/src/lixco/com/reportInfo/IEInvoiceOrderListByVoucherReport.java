...
public class IEInvoiceOrderListByVoucherReport {
	...
	public IEInvoiceOrderListByVoucherReport() {
	}
	
	public IEInvoiceOrderListByVoucherReport(String voucher_code, Date invoice_date, String contract_voucher_code,
